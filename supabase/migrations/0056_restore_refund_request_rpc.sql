-- Restore the buyer refund-request RPC on installations where it was removed by later schema work.
-- A refund request does not move funds directly; it routes the protected order into dispute review.
